...
//! local or global palettes. Palette mapping includes ordered Bayer and
//! Floyd-Steinberg, Atkinson, Burkes, and Sierra-family, Jarvis–Judice–Ninke,
//! Stucki, and Stevenson–Arce error diffusion through [`DitherMode`]. More
...
pub use quantize::{
    ...
    MostUsedQuantizer, NeuQuantQuantizer, OctreeQuantizer, QuantizationSettings, QuantizerStrategy,
};

...
pub use vector_shape::{
    MAX_VECTOR_PREVIEW_SHAPES, VectorShapeGeometry, WpfBrushPaths, prepare_wpf_brush_paths,
    render_wpf_vector_shape, render_wpf_vector_shapes, vector_shape_geometry,

...
struct CandidateReport {
    ...
    surface_maximum_work_per_batch: u64,
    surface_work_policy: &'static str,
...
fn compare_candidate(
    ...
    let mut report = CandidateReport {
        ...
        surface_maximum_work_per_batch: 250_000_000,
        surface_work_policy: "one shared batch ceiling; measured brush/raster charges plus executed pixel passes; no static phase quotas",

...
The main branch additionally covers [effects, shapes, drawing, layer management and project statistics](docs/ADVANCED-EDITOR-LOCALIZATION.md). These later changes are not included in the Preview 3 download.

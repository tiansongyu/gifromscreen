...
Four additional opaque-white-on-transparent coverage probes isolate filled
triangles, fractional triangle vertices, an ellipse and a stroked-only triangle.

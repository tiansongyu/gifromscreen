...
- 同一面板的“Pick window on screen…”提供十字准星选窗：控制面板暂时隐藏，悬停高亮目标，左键松开确认，右键／Escape 取消；清理结束后才恢复控制。当前是先进入选窗再点击目标，不是从按钮按住拖出的手势。[验收与剩余差异](docs/X11-WINDOW-PICKER-QA-2026-09-08.md)

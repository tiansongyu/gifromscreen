...
- X11 显示器录制可在开始前展开“Fit region to a window…”吸附窗口：默认校验窗框提示，也可选择客户区或原生外框。点击时读取新位置，取消／选区改变会使旧结果失效，越界不会静默缩小；这是一次性选区定位，不是窗口跟踪。[原生验收与边界](docs/WINDOW-SNAP-QA-2026-09-08.md)

...
The dropdown remains available alongside the [click-armed crosshair picker](X11-WINDOW-PICKER-QA-2026-09-08.md)
and subsequent [drag-from-button activation](X11-DRAG-PICKER-QA-2026-09-08.md).
Upstream subwindow behavior,

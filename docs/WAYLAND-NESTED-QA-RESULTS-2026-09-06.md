...
- Saved-project reopen, native source-size-change recovery and manual snapshot lifecycle passed; verify discard and additional source-loss paths against the real stack.
...
- Teardown of all recorded labs and their extra-app helpers passed. No recorded lab is still live.

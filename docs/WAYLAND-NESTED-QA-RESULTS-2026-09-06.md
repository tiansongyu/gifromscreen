...
The clean `caa00bc5cbc3ecbd442263bb956f499755180406` source was packaged with Rust 1.88.0 as `target/package-native-20260907/gifromscreen-0.1.0-linux-x86_64.tar.gz`: 11,859,011 bytes, SHA-256 `385e8c4751b725d039b6b16abb7bbb8e7665c62d4b1d09c8a15bb574ab6372d9`. All 12 archive/install/uninstall tests and a fresh-Xvfb packaged-window launch passed locally. Repackaging the same compiled binaries produced an identical archive. This remains a Linux development preview, with the explicit remaining gates above.

...
- [x] Ordinary drawing press ownership, fast-batch input ordering and mapping-change cancellation; [scope and resource contract](DRAWING-PREVIEW-INPUT.md). Included in [Preview 3](LINUX-PREVIEW-3-QA.md), without claiming full ink fidelity.

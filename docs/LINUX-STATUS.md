...
- [x] Click-armed X11 crosshair picker with passive target highlighting, temporary controller hiding, right/Escape cancellation and close-after-cleanup; [native selection/record/GIF evidence](X11-WINDOW-PICKER-QA-2026-09-08.md). Drag-from-button/subwindow parity, partial-window policy and wider WM/CSD acceptance remain open.
